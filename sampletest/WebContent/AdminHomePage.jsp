...
<%
		...
		<hr>
		<h3><center><a href='AddCategory.jsp'><button type="button" class="btn btn-primary-lg">Add Services</button></a></center></h3>
		<h3><center><a href='AddSubcategory.jsp'><button type="button" class="btn btn-primary-lg">Add SubServices</button></a></center></h3>
		<h3><center><a href='DisplayWorker'><button type="button" class="btn btn-primary-lg">Display All Workers</button></a></center></h3> 
